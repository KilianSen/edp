...
// fields stored at rest (git/registry credentials). The key lives in a 0600 file
// in the data dir, separate from the SQLite DB. Ciphertext is tagged with a
// version prefix so plaintext written by older versions still reads back.
package secret
